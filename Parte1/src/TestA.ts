import { Vehiculo } from "./modelo/modeloA/Vehiculo";
import { Detalle } from "./modelo/modeloA/Detalle";
import { HojaRuta } from "./modelo/modeloA/HojaRuta";

export class TestA{

    public static main(){
        let vehiculo: Vehiculo = new Vehiculo();
        let hojaRuta1: HojaRuta = new HojaRuta();
        ...
        console.log(
            ...
            vehiculo.calcularTotalKilometrosRecorridos(
                new Date(2019, 1, 1), new Date(2022, 1, 2)));
    }
}