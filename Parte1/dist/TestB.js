...
const Articulo_1 = require("./modelo/modeloB/Articulo");
const DetalleFactura_1 = require("./modelo/modeloB/DetalleFactura");
const Factura_1 = require("./modelo/modeloB/Factura");
const Cliente_1 = require("./modelo/modeloB/Cliente");
class TestB {
    static main() {
        let cliente = new Cliente_1.Cliente();
        let articulo1 = new Articulo_1.Articulo();
        let articulo2 = new Articulo_1.Articulo();
        let articulo3 = new Articulo_1.Articulo();
        let articulo4 = new Articulo_1.Articulo();
        let articulo5 = new Articulo_1.Articulo();
        let factura1 = new Factura_1.Factura();
        let factura2 = new Factura_1.Factura();
        let factura3 = new Factura_1.Factura();
        let detalleFactura1 = new DetalleFactura_1.DetalleFactura();
        let detalleFactura2 = new DetalleFactura_1.DetalleFactura();
        let detalleFactura3 = new DetalleFactura_1.DetalleFactura();
        let detalleFactura4 = new DetalleFactura_1.DetalleFactura();
        let detalleFactura5 = new DetalleFactura_1.DetalleFactura();
        let detalleFactura6 = new DetalleFactura_1.DetalleFactura();
        cliente.setNumero(1);
